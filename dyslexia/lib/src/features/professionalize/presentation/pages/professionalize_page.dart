                        ...
                        builder: (context, state) {
                          return switch (state) {
                            ProfessionalizeInitial() => _PlaceholderCard(
                                ...
                                description: 'Paste or type text above, then tap Professionalize to generate a concise Professionalized text.',
                                fgColor: fg,
                              ),
                            ProfessionalizeLoading() => const Center(child: CircularProgressIndicator()),
